...
from tests.page_objects_homework import dropdown_page_2, add_remove_page_2, datepicker_page, basicauth_page, \
    basicauth_logged_in_page, form_page, key_presses_page, drag_and_drop_page, status_codes_page, iframe_page
...
class Test(unittest.TestCase):
    ...
    # An alternative solution using xpath locators.
    ...
    # The test extended to 15 elements.
    ...
    def test21_form_submit_first_name_only(self):
        form_page.click_form_tab(self.driver)
        form_page.send_keys_to_first_name(self.driver)
        form_page.click_submit_button(self.driver)
        self.assertTrue(form_page.submit_first_name_only(self.driver))

    def test22_form_submit_last_name_only(self):
        form_page.click_form_tab(self.driver)
        form_page.send_keys_to_last_name(self.driver)
        form_page.click_submit_button(self.driver)
        self.assertTrue(form_page.submit_last_name_only(self.driver))

    def test23_form_submit_empty(self):
        form_page.click_form_tab(self.driver)
        form_page.click_submit_button(self.driver)
        self.assertTrue(form_page.submit_empty_form(self.driver))

    def test24_key_presses_visibility(self):
    ...
    def test25_key_presses_ascii_letters(self):
        key_presses_page.click_key_presses_tab(self.driver)
        self.assertTrue(key_presses_page.press_ascii_letters((self.driver)))

    # The test is considered passed when the list of keys pressed is equal to the keys displayed.
    def test26_key_presses_digits(self):
        key_presses_page.click_key_presses_tab(self.driver)
    ...
    def test27_key_presses_special_keys(self):
        key_presses_page.click_key_presses_tab(self.driver)
    ...
    def test29_drag_and_drop_elements_on_page(self):
        drag_and_drop_page.click_drag_and_drop_tab(self.driver)
        self.assertTrue(drag_and_drop_page.drag_and_drop_move_elements(self.driver))

    def test30_status_codes_visibility(self):
    ...
    def test31_status_code_checking(self):
        status_codes_page.click_status_codes_tab(self.driver)
        self.assertTrue((status_codes_page.status_codes_checking(self.driver)))

    def test32_iframe_visibility(self):
        iframe_page.click_iframe_tab(self.driver)
        self.assertTrue(iframe_page.iframe_content_visible(self.driver))

    def test33_iframe_click_button_1(self):
        iframe_page.click_iframe_tab(self.driver)
        self.assertTrue(iframe_page.click_button_1(self.driver))

    def test34_iframe_click_button_2(self):
        iframe_page.click_iframe_tab(self.driver)
        self.assertTrue(iframe_page.click_button_2(self.driver))
